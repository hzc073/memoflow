...
<p align="center">
  <a href="https://play.google.com/store/apps/details?id=com.memoflow.hzc073"><img src="docs/google-play-download-zh.svg" alt="Google Play 下载" height="40"></a>&nbsp;
  <a href="https://github.com/hzc073/memoflow/releases/latest"><img src="docs/github-release-download-zh.svg" alt="GitHub Release 下载" height="40"></a>&nbsp;
  <a href="https://gemmm.lanzoum.com/b02vri6w2f"><img src="docs/cloud-drive-download-zh.svg" alt="网盘下载，提取码 2nor" height="40"></a>
</p>
...
<p align="center">
  <img src="docs/qq-group.png" alt="MemoFlow QQ 交流群二维码" width="260">
</p>

## 开发者本地 Guard

公共仓库提供本地防泄漏 Guard，用于在提交、合并和推送前检查暂存区或工作区是否误包含私有仓库、IAP、StoreKit、商品 ID 或 App Store 发布配置相关内容。

首次启用 hooks：

```bash
git config core.hooksPath .githooks
chmod +x tools/memoflow_guard.sh
...
## 功能
- 登录与版本适配：支持账号密码/PAT 两种登录方式，登录前可选择并探测 Memos API 版本（0.21~0.29）。
