  ...
  group('DefaultAttachmentPreprocessor', () {
    ...
    test(
      ...
      () async {
        ...
        expect(result.sourceSize, file.lengthSync());
        expect(result.sourceWidth, 48);
        expect(result.sourceHeight, 32);
        expect(result.sourceDisplayWidth, 48);
        expect(result.sourceDisplayHeight, 32);
        expect(result.sourceOrientation, 1);
        expect(result.sizeDelta, 0);
        expect(result.widthDelta, 0);
        expect(result.heightDelta, 0);
        expect(result.widthScale, 1.0);
        expect(result.heightScale, 1.0);
    ...
    test(
      ...
      () async {
        ...
        expect(result.sourceSize, file.lengthSync());
        expect(result.sourceWidth, isNull);
        expect(result.sourceHeight, isNull);
        expect(result.sourceDisplayWidth, isNull);
        expect(result.sourceDisplayHeight, isNull);
        expect(result.sourceOrientation, 1);
        expect(result.sizeDelta, 0);
        expect(result.widthDelta, isNull);
        expect(result.heightDelta, isNull);
        expect(result.widthScale, isNull);
        expect(result.heightScale, isNull);
        expect(pipeline.calls, 0);
      },
    );
    ...
    test('maps pipeline result fields to attachment result', () async {
      ...
      expect(result.sourceDisplayHeight, 32);
      expect(result.sourceOrientation, 1);
      expect(result.sizeDelta, 1230);
      expect(result.widthDelta, 16);
      expect(result.heightDelta, 0);
      expect(result.widthScale, 1.333);
      expect(result.heightScale, 1.0);
