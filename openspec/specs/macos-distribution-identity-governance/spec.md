# macos-distribution-identity-governance Specification

## Purpose
TBD - created by archiving change harden-macos-distribution-keychain-identity. Update Purpose after archive.
## Requirements
