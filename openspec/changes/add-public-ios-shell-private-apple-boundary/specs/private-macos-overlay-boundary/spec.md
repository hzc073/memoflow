...
**Reason**: 该规则已经与当前公开 `macos/` public shell 事实不一致，也会阻止新增公开 `ios/` 基础 Runner。新的治理口径是公开仓可以拥有非商业 Apple public shell scaffolding，私有仓继续拥有 Apple commercial runtime 和 release secrets。

**Migration**: 使用新增的 “Apple public shell scaffolding SHALL be allowed in public repository” 和 “Apple commercial runtime SHALL stay private” 规则替代。
